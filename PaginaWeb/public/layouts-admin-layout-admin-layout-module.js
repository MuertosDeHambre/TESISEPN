...
/* harmony import */ var _service_comentarios_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_service/comentarios.service */ "./src/app/_service/comentarios.service.ts");
...
/* harmony import */ var _service_quejas_sugerencia_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../_service/quejas-sugerencia.service */ "./src/app/_service/quejas-sugerencia.service.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(comentariosSVc, afa, restauranteSvc, quejasScv) {
        this.comentariosSVc = comentariosSVc;
        this.afa = afa;
        this.restauranteSvc = restauranteSvc;
        this.quejasScv = quejasScv;
        this.comentarios = [];
        this.totalComentarios = '';
        this.totalComentariosDueno = 0;
        this.quejas = [];
        this.totalquejas = 0;
        this.sugerencias = [];
        this.totalsugerencias = 0;
        var currenUser = this.afa.auth.currentUser;
    ...
    DashboardComponent.prototype.listarComentarios = function () {
        var _this = this;
        this.comentarios = [];
        this.comentariosSVc.listar().subscribe(function (data) {
            console.log("data", data);
            console.log("user", _this.usuarioLog);
            for (var key$ in data) {
                var comentario = data[key$];
                comentario['uid'] = key$;
                // console.log("key", comentario['uid']);
                _this.comentarios.push(comentario);
                // console.log("aaaa", this.comentarios);
                if (_this.usuarioLog === comentario.uidResta) {
                    console.log("a ver", comentario);
                    _this.totalComentariosDueno = _this.totalComentariosDueno + 1;
                }
            }
        }, function (error) {
            console.log(error);
    ...
    DashboardComponent.prototype.listarQuejas = function () {
        var _this = this;
        this.quejas = [];
        this.quejasScv.listar().subscribe(function (data) {
            data.forEach(function (element) {
                if (element.uidResta === _this.usuarioLog && element.tipo === 'Queja') {
                    _this.quejas.push(element);
                    console.log("quejas", _this.quejas);
                    _this.totalquejas = _this.totalquejas + 1;
                }
            });
        });
    };
    DashboardComponent.prototype.listarSugerencias = function () {
        var _this = this;
        this.sugerencias = [];
        this.quejasScv.listar().subscribe(function (data) {
            data.forEach(function (element) {
                if (element.uidResta === _this.usuarioLog && element.tipo === 'Sugerencia') {
                    _this.sugerencias.push(element);
                    console.log("quejas", _this.sugerencias);
                    _this.totalsugerencias = _this.totalsugerencias + 1;
                }
            });
        });
    };
    DashboardComponent.ctorParameters = function () { return [
        { type: _service_comentarios_service__WEBPACK_IMPORTED_MODULE_2__["ComentariosService"] },
        { type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"] },
        { type: _service_perfil_service__WEBPACK_IMPORTED_MODULE_4__["PerfilService"] },
        { type: _service_quejas_sugerencia_service__WEBPACK_IMPORTED_MODULE_5__["QuejasSugerenciaService"] }
    ]; };
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_service_comentarios_service__WEBPACK_IMPORTED_MODULE_2__["ComentariosService"],
            _angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"],
            _service_perfil_service__WEBPACK_IMPORTED_MODULE_4__["PerfilService"],
            _service_quejas_sugerencia_service__WEBPACK_IMPORTED_MODULE_5__["QuejasSugerenciaService"]])
    ], DashboardComponent);
...
/***/ "./src/app/guards/rol-guard.guard.ts":
/*!*******************************************!*\
  !*** ./src/app/guards/rol-guard.guard.ts ***!
  \*******************************************/
/*! exports provided: RolGuardGuard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RolGuardGuard", function() { return RolGuardGuard; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var RolGuardGuard = /** @class */ (function () {
    function RolGuardGuard() {
    }
    RolGuardGuard.prototype.canActivate = function (next, state) {
    ...
    RolGuardGuard = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        })
    ], RolGuardGuard);
    return RolGuardGuard;
}());
...
/* harmony import */ var _guards_rol_guard_guard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../guards/rol-guard.guard */ "./src/app/guards/rol-guard.guard.ts");
/* harmony import */ var _pages_info_perfil_info_perfil_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../pages/info-perfil/info-perfil.component */ "./src/app/pages/info-perfil/info-perfil.component.ts");
/* harmony import */ var _pages_verficacion_email_verficacion_email_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../pages/verficacion-email/verficacion-email.component */ "./src/app/pages/verficacion-email/verficacion-email.component.ts");
/* harmony import */ var _pages_promociones_promociones_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../pages/promociones/promociones.component */ "./src/app/pages/promociones/promociones.component.ts");
/* harmony import */ var _pages_promociones_lista_promociones_lista_promociones_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../pages/promociones/lista-promociones/lista-promociones.component */ "./src/app/pages/promociones/lista-promociones/lista-promociones.component.ts");
/* harmony import */ var _pages_mi_menu_mi_menu_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../pages/mi-menu/mi-menu.component */ "./src/app/pages/mi-menu/mi-menu.component.ts");
/* harmony import */ var _pages_not403_not403_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../pages/not403/not403.component */ "./src/app/pages/not403/not403.component.ts");
...
/* harmony import */ var _restaurantes_lista_restaurantes_lista_restaurantes_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../restaurantes/lista-restaurantes/lista-restaurantes.component */ "./src/app/restaurantes/lista-restaurantes/lista-restaurantes.component.ts");
/* harmony import */ var _usuarios_afiliados_afiliados_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../usuarios/afiliados/afiliados.component */ "./src/app/usuarios/afiliados/afiliados.component.ts");
/* harmony import */ var _usuarios_no_afiliados_no_afiliados_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../usuarios/no-afiliados/no-afiliados.component */ "./src/app/usuarios/no-afiliados/no-afiliados.component.ts");
/* harmony import */ var _usuarios_lista_usuarios_lista_usuarios_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../usuarios/lista-usuarios/lista-usuarios.component */ "./src/app/usuarios/lista-usuarios/lista-usuarios.component.ts");
/* harmony import */ var _pages_validacion_documento_validacion_documento_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../pages/validacion-documento/validacion-documento.component */ "./src/app/pages/validacion-documento/validacion-documento.component.ts");
/* harmony import */ var _pages_mapa_mapa_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../pages/mapa/mapa.component */ "./src/app/pages/mapa/mapa.component.ts");
/* harmony import */ var _pages_perfil_ver_mapa_restaurante_ver_mapa_restaurante_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../pages/perfil/ver-mapa-restaurante/ver-mapa-restaurante.component */ "./src/app/pages/perfil/ver-mapa-restaurante/ver-mapa-restaurante.component.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
var AdminLayoutRoutes = [
    {
        path: 'dueño', canActivate: [_guards_rol_guard_guard__WEBPACK_IMPORTED_MODULE_1__["RolGuardGuard"]], data: { role: 'dueño' },
        children: [
            //  { path: 'dashboard',                component: DashboardComponent},
            { path: 'restaurante', component: _pages_perfil_perfil_component__WEBPACK_IMPORTED_MODULE_8__["PerfilComponent"] },
            { path: 'miMenu', component: _pages_mi_menu_mi_menu_component__WEBPACK_IMPORTED_MODULE_6__["MiMenuComponent"] },
            { path: 'promociones', component: _pages_promociones_promociones_component__WEBPACK_IMPORTED_MODULE_4__["PromocionesComponent"] },
            { path: 'listaPromociones', component: _pages_promociones_lista_promociones_lista_promociones_component__WEBPACK_IMPORTED_MODULE_5__["ListaPromocionesComponent"] },
            { path: 'afiliados', component: _usuarios_afiliados_afiliados_component__WEBPACK_IMPORTED_MODULE_10__["AfiliadosComponent"] },
            { path: 'noAfiliados', component: _usuarios_no_afiliados_no_afiliados_component__WEBPACK_IMPORTED_MODULE_11__["NoAfiliadosComponent"] },
            { path: 'verificacionE', component: _pages_verficacion_email_verficacion_email_component__WEBPACK_IMPORTED_MODULE_3__["VerficacionEmailComponent"] },
            { path: 'mapa', component: _pages_mapa_mapa_component__WEBPACK_IMPORTED_MODULE_14__["MapaComponent"] },
            { path: 'not-403', component: _pages_not403_not403_component__WEBPACK_IMPORTED_MODULE_7__["Not403Component"] },
            { path: 'verMapa', component: _pages_perfil_ver_mapa_restaurante_ver_mapa_restaurante_component__WEBPACK_IMPORTED_MODULE_15__["VerMapaRestauranteComponent"] },
            { path: 'estadisticas', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_0__["DashboardComponent"] },
            { path: 'perfil', component: _pages_info_perfil_info_perfil_component__WEBPACK_IMPORTED_MODULE_2__["InfoPerfilComponent"] },
            { path: '**', redirectTo: 'perfil' },
        ]
    },
    // canActivate:[RolGuardGuard]
    {
        path: 'admin', canActivate: [_guards_rol_guard_guard__WEBPACK_IMPORTED_MODULE_1__["RolGuardGuard"]], data: { role: 'admin' },
        children: [
            { path: 'perfil', component: _pages_info_perfil_info_perfil_component__WEBPACK_IMPORTED_MODULE_2__["InfoPerfilComponent"] },
            { path: 'listaU', component: _usuarios_lista_usuarios_lista_usuarios_component__WEBPACK_IMPORTED_MODULE_12__["ListaUsuariosComponent"] },
            { path: 'listaR', component: _restaurantes_lista_restaurantes_lista_restaurantes_component__WEBPACK_IMPORTED_MODULE_9__["ListaRestaurantesComponent"] },
            //    {path: 'verificacionR',              component: VerificacionRestaurantesComponent},
            { path: 'verificacionDoc', component: _pages_validacion_documento_validacion_documento_component__WEBPACK_IMPORTED_MODULE_13__["ValidacionDocumentoComponent"] },
            { path: 'verificacionE', component: _pages_verficacion_email_verficacion_email_component__WEBPACK_IMPORTED_MODULE_3__["VerficacionEmailComponent"] },
            { path: '**', redirectTo: 'perfil' },
        ]
    },
    {
        path: 'cliente', canActivate: [_guards_rol_guard_guard__WEBPACK_IMPORTED_MODULE_1__["RolGuardGuard"]], data: { role: 'cliente' },
        children: [
            { path: 'not-403', component: _pages_not403_not403_component__WEBPACK_IMPORTED_MODULE_7__["Not403Component"] },
            { path: '**', redirectTo: 'perfil' },
        ]
